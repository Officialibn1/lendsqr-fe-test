...
const UserDetailsPage = () => {
  ...
  if (isLoading)
    return <Skeleton className={styles.infoCard} style={{ height: "80vh" }} />;
  ...
  return (
    <main className={styles.section}>
      <Link to="/dashboard" className={styles.backLink}>
        <img src={back} className={styles.backLinkIcon} /> Back to Users
      </Link>
      ...
      <header className={styles.header}>
        <div className={styles.profileInfoContainer}>
          ...
          <div className={styles.accountDetails}>
            <h1>{formatCurrency(user.accountBalance)}</h1>
        ...
        <section className={styles.infoSection}>
          ...
          <div className={styles.infoGrid2}>
            ...
            <div className={styles.infoGroup}>
              ...
              <p>{formatCurrency(user.education.loanRepayment)}</p>
            </div>
          </div>
        </section>
